// Generated from E:/My_project_compiler/Test_2/src/antlr/TypeScriptLexer.g4 by ANTLR 4.13.2
package src.antlr;
...
public class TypeScriptLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ELSE", "IMPORT", "FROM", "EXPORT", "CLASS", "IF", "ENUM", "AS", "FUNCTION", 
			"TUPLE", "BOOLEAN", "NULL", "THIS", "NOT", "LET", "RETURN", "TYPE", "ARRAY_TYPE", 
			"ARRAY_TYPE_BRACKETS", "OPERATION", "COMPARISON_OPERATOR", "LOGICAL_OPERATOR", 
			"IDENTIFIER", "STRING", "NUMBER", "LCURLY", "RCURLY", "LPAREN", "RPAREN", 
			"LBRACK", "RBRACK", "COLON", "SEMICOLON", "COMMA", "ARROW", "BACKTICK", 
			"SDOLER", "QUESTION_MARK", "SPREAD", "OR", "EQ", "DOT", "WS", "LINE_COMMENT", 
			"BLOCK_COMMENT", "DIGIT", "LETTER", "ESCAPED_CHAR"
		};
	}
